  ...
  return (
    <main className="mt-8 px-4">
      <div className="flex gap-8">
        <section className="w-full max-w-[400px] bg-white rounded-[20px] p-7 space-y-6">
          <div className="border border-[#DBDBDB] bg-white p-1 rounded-xl">
            <div className="flex relative">
              ...
              <div
                className="absolute bottom-0 w-[calc(100%-50%)] h-[40px] bg-primary-blue custom-transition rounded-lg"
          ...
          <div className="mt-10 flex flex-col items-center space-y-7">
            ...
            <div className="flex gap-x-4">
              <div className="cursor-pointer bg-white p-3 rounded-2xl hover:shadow-xl transition duration-500">
                <Image src="/images/hand-bag.png" alt="" width={200} height={200} />
              </div>
              <div className="cursor-pointer bg-white p-3 rounded-2xl hover:shadow-xl transition duration-500">
                <Image src="/images/shoes.png" alt="" width={200} height={200} />
              </div>
              <div className="cursor-pointer bg-white p-3 rounded-2xl hover:shadow-xl transition duration-500">
                <Image src="/images/sofa.png" alt="" width={200} height={200} />
              </div>
              <div className="cursor-pointer bg-white p-3 rounded-2xl hover:shadow-xl transition duration-500">
                <Image src="/images/camera.png" alt="" width={200} height={200} />
              </div>
            </div>
          </div>
        </section>
      </div>
      <div className="bg-primary-blue p-3 rounded-full text-white w-fit fixed bottom-0 right-0 m-5 z-[10]">Credits 50 / 50</div>
    </main>
  );
}
